...
Gilt is a private finance tracker for iPhone — your money data lives in your own iCloud, never on anyone's servers.

## Short description (~50 words)

Gilt is a personal finance tracker for iPhone that keeps your data yours: no servers, no accounts, no tracking — everything syncs through your own iCloud. It handles multiple currencies with live rates, family budgets shared via iCloud, and a unique BYO-AI import that turns bank statements into transactions using your own AI assistant.

## Full description / boilerplate (~150 words)
...
| Website | https://gilt.money |
| Press contact | support@gilt.money |
| Developer | Harut Aristakesyan & family (Armenia) |
| Released | July 2026 |
| Community | r/GiltApp |

## Story angles

1. **"Data Not Collected" as the product**: a finance tracker with no servers at all — data lives in the user's iCloud, so privacy is structural, not declarative.
2. **BYO-AI**: instead of bank integrations, a tailored prompt for YOUR ChatGPT/Claude. An AI feature with zero data leakage to the developer.
3. **A family team vs. the aggregators**: an indie story against the Plaid model of "hand over your bank login" — one person writing the code, a household actually living on the product.
...
**How does family sharing work?** Through iCloud sharing: data flows between family members directly via Apple, never through the developer.
